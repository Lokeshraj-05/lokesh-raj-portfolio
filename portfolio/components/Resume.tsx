        ...
        <div className="mt-14 grid gap-8 md:grid-cols-[0.85fr_1.15fr] md:items-center">
          <Reveal>
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(143,206,212,0.12) 0%, rgba(143,206,212,0.05) 50%, transparent 75%)",
                filter: "blur(32px)",
            ...
            <motion.div
              ...
              style={{
                boxShadow: "0 0 0 1px rgba(143,206,212,0.22), 0 0 28px rgba(143,206,212,0.10), 0 16px 40px rgba(0,0,0,0.48)",
              }}
            >
              ...
              <motion.div
                animate={{
                  boxShadow: [
                    "0 0 0 1px rgba(143,206,212,0.22), 0 0 22px rgba(143,206,212,0.09)",
                    "0 0 0 1px rgba(143,206,212,0.36), 0 0 34px rgba(143,206,212,0.16)",
                    "0 0 0 1px rgba(143,206,212,0.22), 0 0 22px rgba(143,206,212,0.09)",
                  ],
                }}
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(143,206,212,0.22)",
          ...
          <Reveal delay={0.15}>
            <div
              className="card-hover rounded-[2rem] border border-white/[0.06] bg-[#0e0e0e] p-8 sm:p-9"
              style={{ boxShadow: "0 0 0 1px rgba(143,206,212,0.14), inset 0 1px 0 rgba(143,206,212,0.10), 0 12px 32px rgba(0,0,0,0.40)" }}
            >
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  download
                  data-cursor-hover
                  className="inline-flex items-center gap-2 rounded-full border border-dashed border-[rgba(143,206,212,0.35)] px-6 py-3.5 text-sm font-semibold text-foreground transition-all hover:border-primary hover:bg-[#141414]"
                >
                  <Download size={16} />
                  Download PDF
                </a>
