    ...
    <section id="research" className="relative py-28 md:py-36">
      <div className="section-container">
        ...
        <Reveal delay={0.1} className="mt-14">
          <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.06] bg-[#0c0c0c] p-8 sm:p-10">
            {/* Left accent bar */}
            ...
            <div className="relative flex flex-col gap-6 md:flex-row md:items-start md:justify-between md:pl-4">
              <div className="flex gap-5">
                <div className="hidden h-16 w-16 shrink-0 flex-col items-center justify-center border border-[rgba(143,163,184,0.15)] bg-[#141414] text-primary sm:flex">
                  <FileText size={24} />
                  <span className="mt-1 font-mono text-[8px] uppercase tracking-widest text-muted">Pub</span>
                </div>
                <div>
                  <span className="mb-3 inline-flex items-center gap-1.5 border border-[rgba(143,163,184,0.18)] bg-[#111111] px-3 py-1 font-mono text-[10px] font-semibold uppercase tracking-wider text-primary" style={{ borderRadius: "999px" }}>
                    <BadgeCheck size={12} />
              ...
              <a
                ...
                data-cursor-hover
                className="btn-secondary shrink-0 self-start px-6 py-3.5 text-sm md:self-center"
              >
                View Publication
