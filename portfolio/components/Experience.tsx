        ...
        <div className="mt-14 space-y-6">
          {experience.map((exp, i) => (
            <Reveal key={exp.id} delay={i * 0.1}>
              <div className="card-hover grid gap-6 rounded-[2rem] border border-white/[0.05] bg-[#0e0e0e] p-7 transition-all duration-400 sm:p-9 md:grid-cols-[1fr_2fr] md:gap-10"
                style={{ boxShadow: "0 0 0 1px rgba(143,206,212,0.12), 0 12px 32px rgba(0,0,0,0.40)" }}
              >
                {/* Left column — role metadata */}
                <div className="relative md:border-r md:border-white/[0.05] md:pr-8">
                  <div className="mb-5 flex h-10 w-10 items-center justify-center border border-[rgba(143,206,212,0.30)] bg-[#141414] text-primary" style={{ borderRadius: "6px" }}>
                    <Briefcase size={18} />
                  </div>
