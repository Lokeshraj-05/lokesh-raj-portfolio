    ...
    >
      ...
      <div className="section-container flex flex-col items-center text-center">
        ...
        >
          <motion.div
            variants={item}
            className="eyebrow mb-6 flex items-center gap-2.5 border border-[rgba(143,206,212,0.30)] bg-[#0e0e0e] px-4 py-1.5"
            style={{ boxShadow: "0 0 0 1px rgba(143,206,212,0.16), inset 0 1px 0 rgba(143,206,212,0.10)", borderRadius: "999px" }}
          >
